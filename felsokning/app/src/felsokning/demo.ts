...
export function byggDemoArende(nummer: number, anvandare = "Anna"): Arende {
  ...
  const handelser: LoggPost[] = [
    ...
    post(22, { typ: "kontroll_utford", stegId: "visuell", kontrollId: "dot", text: "Dokumentera DOT-/tillverkningsdatum", resultat: "Front: DOT 2318, rear: DOT 2318 — all from week 23 of 2018" }),
    ...
    post(33, { typ: "kontroll_utford", stegId: "kontroller", kontrollId: "lufttryck", text: "Kontrollera lufttryck", resultat: "LF 2.4 / RF 2.1 / LR 2.4 / RR 2.4 bar — adjusted to 2.4 all round" }),
    ...
    post(58, { typ: "kontroll_utford", stegId: "provkorning", kontrollId: "pk_var", text: "Whether the vibration is felt in the steering wheel or the body", resultat: "Endast i ratten" }),
    ...
    post(83, { typ: "kontroll_utford", stegId: "kontroller", kontrollId: "balansering", text: "Kontrollera hjulbalansering", resultat: "38 g imbalance right front — a balance weight is missing. The other wheels within 5 g." }),
