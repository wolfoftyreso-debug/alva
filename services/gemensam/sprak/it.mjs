...
export const IT = {
  ...
  "grind.anmarkning.bevis": "I rilievi portano una prova visiva",
  "grind.anmarkning.saknas": "Un guasto riparato deve essere registrato come rilievo",
  "grind.anmarkning.saknas.detalj": "È stato eseguito un intervento ed è stata stabilita una causa, ma nessun controllo è contrassegnato come rilievo. Ciò che è stato riparato non compare quindi nel registro come un riscontro.",
  ...
  "sammanfattning.objekt": "La pratica riguarda {objekt}.",
  "sammanfattning.objekt_utan_namn": "La pratica riguarda un oggetto identificato.",
  "sammanfattning.objekt_saknas": "L’oggetto non è identificato nel registro.",
  "sammanfattning.kundbeskrivning": "Il cliente ha descritto: «{text}»",
  "sammanfattning.repro.ja": "Il sintomo è stato riprodotto.",
  "sammanfattning.repro.delvis": "Il sintomo è stato riprodotto parzialmente.",
  "sammanfattning.repro.nej":
    "Il sintomo non è stato riproducibile nelle condizioni presenti durante l’esame.",
  "sammanfattning.repro.dokumenterad": "La riproduzione è documentata.",
  "sammanfattning.orsak_ej_faststalld": "La causa non è stata accertata: {motivering}",
  "sammanfattning.avvikelse": "Anomalia constatata: {avvikelse}",
  "sammanfattning.bedomd_orsak": "Causa stimata: {kategori}.",
  "sammanfattning.motivering": "Motivazione: {motivering}",
  "sammanfattning.atgard_utford": "Intervento eseguito: {beskrivning}",
  "sammanfattning.atgard_ej_utford": "Nessun intervento eseguito: {motivering}",
  "sammanfattning.kvalitet.symptomet_borta": "Al controllo qualità il sintomo era scomparso.",
  "sammanfattning.kvalitet.kvarstar": "Al controllo qualità il sintomo persisteva.",
  "sammanfattning.kvalitet.delvis": "Al controllo qualità il sintomo persisteva parzialmente.",
  "sammanfattning.kvalitet.ej_verifierbar": "Il controllo qualità non ha potuto verificare l’esito.",
  "sammanfattning.kvalitet.dokumenterad": "Il controllo qualità è documentato.",
  "sammanfattning.kvarstaende": "Da completare: {text}",
  "sammanfattning.rad.oidentifierat": "Oggetto non identificato",
  "sammanfattning.rad.pagaende": "{vad} — in corso.",
  "sammanfattning.rad.utan_orsak": "{vad} — chiusa senza causa accertata.",
  "sammanfattning.rad.avslutat": "{vad} — chiusa.",
  "delning.rubrik.fall": "Pratica",
  "delning.rubrik.delat": "Pratica condivisa",
  "delning.status.avslutat": "Chiusa",
  "delning.status.pagaende": "Diagnosi in corso",
  "delning.identitet.arbetsorder": "Ordine di lavoro",
  "delning.identitet.claim": "Claim",
  "delning.identitet.skadenummer": "N. sinistro",
  "delning.identitet.regnr": "Targa",
  "delning.identitet.vin": "VIN",
  "delning.identitet.miltal": "Chilometraggio",
  "delning.identitet.ansvarig": "Tecnico responsabile",
  "delning.identitet.status": "Stato",
  "delning.rubrik.sammanfattning": "Sintesi",
  "delning.rubrik.slutsats": "Conclusione e motivazione",
  "delning.slutsats.ej_faststalld": "Motivo per cui la causa non è stata accertata",
  "delning.slutsats.motivering": "Motivazione",
  "delning.slutsats.uteslutet": "Alternative escluse",
  "delning.slutsats.atgardsval": "Scelta dell’intervento",
  "delning.slutsats.kvarstaende": "Incertezza residua",
  "delning.rubrik.felbeskrivning": "Descrizione del guasto da parte del cliente",
  "delning.rubrik.forslag": "Intervento proposto",
  "delning.forslag.kostnad": "Costo stimato: {kostnad}",
  "delning.forslag.beslut": "La sua decisione: {beslut}",
  "delning.forslag.via": "(registrata tramite {kanal})",
  "delning.forslag.vantar":
    "In attesa della sua decisione — contatti l’officina per approvare o rifiutare.",
  "delning.beslut.rubrik": "La sua decisione all’officina",
  "delning.beslut.godkann": "Approva l’intervento",
  "delning.beslut.avboj": "Rifiuta",
  "delning.beslut.kommentar": "Commento (facoltativo)",
  "delning.beslut.motivering": "Breve motivazione (facoltativa)",
  "delning.beslut.skickar": "Invio in corso …",
  "delning.beslut.skicka": "Invia la decisione",
  "delning.beslut.info":
    "La decisione viene registrata nella pratica e non può essere modificata qui — contatti l’officina se cambia idea.",
  "delning.beslut.godkant": "Approvato",
  "delning.beslut.avbojt": "Rifiutato",
  "delning.beslut.delvis": "Parzialmente approvato",
  "delning.beslut.fel.plattform": "La decisione non può essere comunicata qui — contatti l’officina.",
  "delning.beslut.fel.registrering": "La decisione non è stata registrata — riprovi.",
  "delning.beslut.fel.forbindelse": "La decisione non è stata inviata — verifichi la connessione.",
  "delning.rubrik.laget": "Stato attuale",
  "delning.rubrik.video": "Video",
  "delning.rubrik.bilder": "Immagini",
  "delning.rubrik.matningar": "Misurazioni",
  "delning.rubrik.tidslinje": "Cronologia",
  "delning.tidslinje.arbetssprak": "Le voci sono riportate testualmente, nella lingua di lavoro dell’officina.",
  "delning.rubrik.nasta": "Prossimo passo consigliato",
  "delning.rubrik.arbetstid": "Tempo di lavoro",
  "delning.fot": "Pratica #{nummer} · aperta il {datum} · generata dal registro della pratica",
  "delning.notis.kund":
    "Vista in tempo reale di sola lettura dall’officina — la pagina si aggiorna automaticamente man mano che vengono registrate nuove informazioni.",
  "delning.notis.partner":
    "Vista in tempo reale di sola lettura (livello partner) — include ipotesi tecniche, chiaramente contrassegnate come non verificate. Si aggiorna automaticamente.",
  "delning.notis.intern":
    "Vista in tempo reale di sola lettura (livello interno) — piena visibilità della pratica. Si aggiorna automaticamente.",
  "delning.hamtar": "Recupero della pratica …",
  "delning.saknas": "La pratica non è disponibile. Verifichi il link con l’officina — la condivisione potrebbe essere stata revocata.",
};
