...
export const RO = {
  ...
  "grind.anmarkning.bevis": "Constatările poartă dovadă vizuală",
  "grind.anmarkning.saknas": "O defecțiune reparată trebuie consemnată ca o constatare",
  "grind.anmarkning.saknas.detalj": "S-a executat o lucrare și s-a stabilit o cauză, dar niciun control nu este marcat ca o constatare. Ceea ce a fost reparat nu apare atunci nicăieri în jurnal ca o descoperire.",
  ...
  "sammanfattning.objekt": "Cazul privește {objekt}.",
  "sammanfattning.objekt_utan_namn": "Cazul privește un obiect identificat.",
  "sammanfattning.objekt_saknas": "Obiectul nu este identificat în jurnal.",
  "sammanfattning.kundbeskrivning": "Clientul a descris: „{text}”",
  "sammanfattning.repro.ja": "Simptomul a fost reprodus.",
  "sammanfattning.repro.delvis": "Simptomul a putut fi reprodus parțial.",
  "sammanfattning.repro.nej":
    "Simptomul nu a putut fi reprodus în condițiile prezente în timpul examinării.",
  "sammanfattning.repro.dokumenterad": "Reproducerea este documentată.",
  "sammanfattning.orsak_ej_faststalld": "Cauza nu a putut fi stabilită: {motivering}",
  "sammanfattning.avvikelse": "Abatere constatată: {avvikelse}",
  "sammanfattning.bedomd_orsak": "Cauză apreciată: {kategori}.",
  "sammanfattning.motivering": "Motivare: {motivering}",
  "sammanfattning.atgard_utford": "Intervenție efectuată: {beskrivning}",
  "sammanfattning.atgard_ej_utford": "Nu s-a efectuat nicio intervenție: {motivering}",
  "sammanfattning.kvalitet.symptomet_borta": "La controlul de calitate simptomul dispăruse.",
  "sammanfattning.kvalitet.kvarstar": "La controlul de calitate simptomul persista.",
  "sammanfattning.kvalitet.delvis": "La controlul de calitate simptomul persista parțial.",
  "sammanfattning.kvalitet.ej_verifierbar": "Controlul de calitate nu a putut verifica rezultatul.",
  "sammanfattning.kvalitet.dokumenterad": "Controlul de calitate este documentat.",
  "sammanfattning.kvarstaende": "Rămas de rezolvat: {text}",
  "sammanfattning.rad.oidentifierat": "Obiect neidentificat",
  "sammanfattning.rad.pagaende": "{vad} — în curs.",
  "sammanfattning.rad.utan_orsak": "{vad} — închis fără cauză stabilită.",
  "sammanfattning.rad.avslutat": "{vad} — închis.",
  "delning.rubrik.fall": "Caz",
  "delning.rubrik.delat": "Caz partajat",
  "delning.status.avslutat": "Închis",
  "delning.status.pagaende": "Diagnoză în curs",
  "delning.identitet.arbetsorder": "Comandă de lucru",
  "delning.identitet.claim": "Claim",
  "delning.identitet.skadenummer": "Nr. daună",
  "delning.identitet.regnr": "Nr. înmatriculare",
  "delning.identitet.vin": "VIN",
  "delning.identitet.miltal": "Kilometraj",
  "delning.identitet.ansvarig": "Tehnician responsabil",
  "delning.identitet.status": "Stare",
  "delning.rubrik.sammanfattning": "Rezumat",
  "delning.rubrik.slutsats": "Concluzie și motivare",
  "delning.slutsats.ej_faststalld": "Motivul pentru care cauza nu a putut fi stabilită",
  "delning.slutsats.motivering": "Motivare",
  "delning.slutsats.uteslutet": "Alternative excluse",
  "delning.slutsats.atgardsval": "Alegerea intervenției",
  "delning.slutsats.kvarstaende": "Incertitudine rămasă",
  "delning.rubrik.felbeskrivning": "Descrierea defecțiunii de către client",
  "delning.rubrik.forslag": "Intervenție propusă",
  "delning.forslag.kostnad": "Cost estimat: {kostnad}",
  "delning.forslag.beslut": "Decizia dumneavoastră: {beslut}",
  "delning.forslag.via": "(înregistrată prin {kanal})",
  "delning.forslag.vantar":
    "În așteptarea deciziei dumneavoastră — contactați atelierul pentru a aproba sau a refuza.",
  "delning.beslut.rubrik": "Decizia dumneavoastră către atelier",
  "delning.beslut.godkann": "Aprobați intervenția",
  "delning.beslut.avboj": "Refuzați",
  "delning.beslut.kommentar": "Comentariu (opțional)",
  "delning.beslut.motivering": "Motivare scurtă (opțională)",
  "delning.beslut.skickar": "Se trimite …",
  "delning.beslut.skicka": "Trimiteți decizia",
  "delning.beslut.info":
    "Decizia se consemnează în caz și nu poate fi modificată aici — contactați atelierul dacă vă răzgândiți.",
  "delning.beslut.godkant": "Aprobată",
  "delning.beslut.avbojt": "Refuzată",
  "delning.beslut.delvis": "Parțial aprobată",
  "delning.beslut.fel.plattform": "Decizia nu poate fi transmisă aici — contactați atelierul.",
  "delning.beslut.fel.registrering": "Decizia nu a putut fi înregistrată — încercați din nou.",
  "delning.beslut.fel.forbindelse": "Decizia nu a putut fi trimisă — verificați conexiunea.",
  "delning.rubrik.laget": "Situația actuală",
  "delning.rubrik.video": "Video",
  "delning.rubrik.bilder": "Imagini",
  "delning.rubrik.matningar": "Măsurători",
  "delning.rubrik.tidslinje": "Cronologie",
  "delning.tidslinje.arbetssprak": "Înregistrările sunt redate cuvânt cu cuvânt, în limba de lucru a atelierului.",
  "delning.rubrik.nasta": "Următorul pas recomandat",
  "delning.rubrik.arbetstid": "Timp de lucru",
  "delning.fot": "Caz #{nummer} · deschis {datum} · generat din jurnalul cazului",
  "delning.notis.kund":
    "Vizualizare live, doar în citire, din atelier — pagina se actualizează automat pe măsură ce se consemnează informații noi.",
  "delning.notis.partner":
    "Vizualizare live doar în citire (nivel partener) — include ipoteze tehnice, marcate clar ca neverificate. Se actualizează automat.",
  "delning.notis.intern":
    "Vizualizare live doar în citire (nivel intern) — vizibilitate completă asupra cazului. Se actualizează automat.",
  "delning.hamtar": "Se preia cazul …",
  "delning.saknas": "Cazul nu este disponibil. Verificați linkul cu atelierul — partajarea poate să fi fost revocată.",
};
