...
export const DE = {
  ...
  "grind.anmarkning.bevis": "Feststellungen tragen visuelle Nachweise",
  "grind.anmarkning.saknas": "Ein behobener Fehler muss als Feststellung erfasst sein",
  "grind.anmarkning.saknas.detalj": "Eine Arbeit wurde ausgeführt und eine Fehlerursache festgestellt, aber keine Prüfung ist als Feststellung markiert. Das Reparierte erscheint dann nirgends im Protokoll als Befund.",
  ...
  "sammanfattning.objekt": "Der Vorgang betrifft {objekt}.",
  "sammanfattning.objekt_utan_namn": "Der Vorgang betrifft ein identifiziertes Objekt.",
  "sammanfattning.objekt_saknas": "Das Objekt ist im Protokoll nicht identifiziert.",
  "sammanfattning.kundbeskrivning": "Der Kunde beschrieb: „{text}“",
  "sammanfattning.repro.ja": "Das Symptom wurde reproduziert.",
  "sammanfattning.repro.delvis": "Das Symptom konnte teilweise reproduziert werden.",
  "sammanfattning.repro.nej":
    "Das Symptom konnte unter den bei der Untersuchung herrschenden Bedingungen nicht reproduziert werden.",
  "sammanfattning.repro.dokumenterad": "Die Reproduktion ist dokumentiert.",
  "sammanfattning.orsak_ej_faststalld": "Die Ursache konnte nicht festgestellt werden: {motivering}",
  "sammanfattning.avvikelse": "Festgestellte Abweichung: {avvikelse}",
  "sammanfattning.bedomd_orsak": "Beurteilte Ursache: {kategori}.",
  "sammanfattning.motivering": "Begründung: {motivering}",
  "sammanfattning.atgard_utford": "Durchgeführte Maßnahme: {beskrivning}",
  "sammanfattning.atgard_ej_utford": "Keine Maßnahme durchgeführt: {motivering}",
  "sammanfattning.kvalitet.symptomet_borta": "Bei der Qualitätskontrolle war das Symptom verschwunden.",
  "sammanfattning.kvalitet.kvarstar": "Bei der Qualitätskontrolle bestand das Symptom weiterhin.",
  "sammanfattning.kvalitet.delvis": "Bei der Qualitätskontrolle bestand das Symptom teilweise weiterhin.",
  "sammanfattning.kvalitet.ej_verifierbar": "Die Qualitätskontrolle konnte das Ergebnis nicht verifizieren.",
  "sammanfattning.kvalitet.dokumenterad": "Die Qualitätskontrolle ist dokumentiert.",
  "sammanfattning.kvarstaende": "Verbleibend: {text}",
  "sammanfattning.rad.oidentifierat": "Nicht identifiziertes Objekt",
  "sammanfattning.rad.pagaende": "{vad} — in Bearbeitung.",
  "sammanfattning.rad.utan_orsak": "{vad} — abgeschlossen ohne festgestellte Ursache.",
  "sammanfattning.rad.avslutat": "{vad} — abgeschlossen.",
  "delning.rubrik.fall": "Vorgang",
  "delning.rubrik.delat": "Geteilter Vorgang",
  "delning.status.avslutat": "Abgeschlossen",
  "delning.status.pagaende": "Diagnose läuft",
  "delning.identitet.arbetsorder": "Arbeitsauftrag",
  "delning.identitet.claim": "Claim",
  "delning.identitet.skadenummer": "Schadennummer",
  "delning.identitet.regnr": "Kennzeichen",
  "delning.identitet.vin": "FIN",
  "delning.identitet.miltal": "Kilometerstand",
  "delning.identitet.ansvarig": "Verantwortlicher Techniker",
  "delning.identitet.status": "Status",
  "delning.rubrik.sammanfattning": "Zusammenfassung",
  "delning.rubrik.slutsats": "Schlusswort und Begründung",
  "delning.slutsats.ej_faststalld": "Grund, weshalb die Ursache nicht festgestellt werden konnte",
  "delning.slutsats.motivering": "Begründung",
  "delning.slutsats.uteslutet": "Ausgeschlossene Alternativen",
  "delning.slutsats.atgardsval": "Wahl der Maßnahme",
  "delning.slutsats.kvarstaende": "Verbleibende Unsicherheit",
  "delning.rubrik.felbeskrivning": "Fehlerbeschreibung des Kunden",
  "delning.rubrik.forslag": "Vorgeschlagene Maßnahme",
  "delning.forslag.kostnad": "Geschätzte Kosten: {kostnad}",
  "delning.forslag.beslut": "Ihre Entscheidung: {beslut}",
  "delning.forslag.via": "(erfasst über {kanal})",
  "delning.forslag.vantar":
    "Ihre Entscheidung steht aus — kontaktieren Sie die Werkstatt, um zuzustimmen oder abzulehnen.",
  "delning.beslut.rubrik": "Ihre Entscheidung an die Werkstatt",
  "delning.beslut.godkann": "Maßnahme genehmigen",
  "delning.beslut.avboj": "Ablehnen",
  "delning.beslut.kommentar": "Kommentar (optional)",
  "delning.beslut.motivering": "Kurze Begründung (optional)",
  "delning.beslut.skickar": "Wird gesendet …",
  "delning.beslut.skicka": "Entscheidung senden",
  "delning.beslut.info":
    "Die Entscheidung wird im Vorgang verbucht und kann hier nicht geändert werden — kontaktieren Sie die Werkstatt, wenn Sie es sich anders überlegen.",
  "delning.beslut.godkant": "Genehmigt",
  "delning.beslut.avbojt": "Abgelehnt",
  "delning.beslut.delvis": "Teilweise genehmigt",
  "delning.beslut.fel.plattform": "Die Entscheidung kann hier nicht abgegeben werden — kontaktieren Sie die Werkstatt.",
  "delning.beslut.fel.registrering": "Die Entscheidung konnte nicht erfasst werden — versuchen Sie es erneut.",
  "delning.beslut.fel.forbindelse": "Die Entscheidung konnte nicht gesendet werden — prüfen Sie die Verbindung.",
  "delning.rubrik.laget": "Aktueller Stand",
  "delning.rubrik.video": "Video",
  "delning.rubrik.bilder": "Bilder",
  "delning.rubrik.matningar": "Messungen",
  "delning.rubrik.tidslinje": "Zeitverlauf",
  "delning.tidslinje.arbetssprak": "Die Einträge werden wörtlich wiedergegeben, in der Arbeitssprache der Werkstatt.",
  "delning.rubrik.nasta": "Empfohlener nächster Schritt",
  "delning.rubrik.arbetstid": "Arbeitszeit",
  "delning.fot": "Vorgang #{nummer} · begonnen {datum} · aus dem Vorgangsprotokoll erzeugt",
  "delning.notis.kund":
    "Schreibgeschützte Live-Ansicht der Werkstatt — die Seite aktualisiert sich automatisch, sobald neue Informationen verbucht werden.",
  "delning.notis.partner":
    "Schreibgeschützte Live-Ansicht (Partnerebene) — enthält technische Hypothesen, deutlich als unbestätigt gekennzeichnet. Aktualisiert sich automatisch.",
  "delning.notis.intern":
    "Schreibgeschützte Live-Ansicht (interne Ebene) — volle Einsicht in den Vorgang. Aktualisiert sich automatisch.",
  "delning.hamtar": "Vorgang wird abgerufen …",
  "delning.saknas": "Der Vorgang ist nicht verfügbar. Klären Sie den Link mit der Werkstatt — die Freigabe kann widerrufen worden sein.",
};
