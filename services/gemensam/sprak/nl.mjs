...
export const NL = {
  ...
  "grind.anmarkning.bevis": "Bevindingen dragen visueel bewijs",
  "grind.anmarkning.saknas": "Een gerepareerd defect moet als bevinding zijn vastgelegd",
  "grind.anmarkning.saknas.detalj": "Er is werk uitgevoerd en een oorzaak vastgesteld, maar geen controle is als bevinding gemarkeerd. Wat gerepareerd is, komt dan nergens in het logboek voor als iets dat is aangetroffen.",
  ...
  "sammanfattning.objekt": "De zaak betreft {objekt}.",
  "sammanfattning.objekt_utan_namn": "De zaak betreft een geïdentificeerd object.",
  "sammanfattning.objekt_saknas": "Het object is niet geïdentificeerd in het logboek.",
  "sammanfattning.kundbeskrivning": "De klant beschreef: “{text}”",
  "sammanfattning.repro.ja": "Het symptoom is gereproduceerd.",
  "sammanfattning.repro.delvis": "Het symptoom kon gedeeltelijk worden gereproduceerd.",
  "sammanfattning.repro.nej":
    "Het symptoom kon niet worden gereproduceerd onder de omstandigheden tijdens het onderzoek.",
  "sammanfattning.repro.dokumenterad": "De reproductie is gedocumenteerd.",
  "sammanfattning.orsak_ej_faststalld": "De oorzaak kon niet worden vastgesteld: {motivering}",
  "sammanfattning.avvikelse": "Vastgestelde afwijking: {avvikelse}",
  "sammanfattning.bedomd_orsak": "Beoordeelde oorzaak: {kategori}.",
  "sammanfattning.motivering": "Onderbouwing: {motivering}",
  "sammanfattning.atgard_utford": "Uitgevoerde handeling: {beskrivning}",
  "sammanfattning.atgard_ej_utford": "Geen handeling uitgevoerd: {motivering}",
  "sammanfattning.kvalitet.symptomet_borta": "Bij de kwaliteitscontrole was het symptoom verdwenen.",
  "sammanfattning.kvalitet.kvarstar": "Bij de kwaliteitscontrole bleef het symptoom bestaan.",
  "sammanfattning.kvalitet.delvis": "Bij de kwaliteitscontrole bleef het symptoom gedeeltelijk bestaan.",
  "sammanfattning.kvalitet.ej_verifierbar": "De kwaliteitscontrole kon het resultaat niet verifiëren.",
  "sammanfattning.kvalitet.dokumenterad": "De kwaliteitscontrole is gedocumenteerd.",
  "sammanfattning.kvarstaende": "Resterend: {text}",
  "sammanfattning.rad.oidentifierat": "Niet-geïdentificeerd object",
  "sammanfattning.rad.pagaende": "{vad} — in behandeling.",
  "sammanfattning.rad.utan_orsak": "{vad} — gesloten zonder vastgestelde oorzaak.",
  "sammanfattning.rad.avslutat": "{vad} — gesloten.",
  "delning.rubrik.fall": "Zaak",
  "delning.rubrik.delat": "Gedeelde zaak",
  "delning.status.avslutat": "Gesloten",
  "delning.status.pagaende": "Diagnose loopt",
  "delning.identitet.arbetsorder": "Werkorder",
  "delning.identitet.claim": "Claim",
  "delning.identitet.skadenummer": "Schadenummer",
  "delning.identitet.regnr": "Kenteken",
  "delning.identitet.vin": "VIN",
  "delning.identitet.miltal": "Kilometerstand",
  "delning.identitet.ansvarig": "Verantwoordelijk technicus",
  "delning.identitet.status": "Status",
  "delning.rubrik.sammanfattning": "Samenvatting",
  "delning.rubrik.slutsats": "Slotverklaring en onderbouwing",
  "delning.slutsats.ej_faststalld": "Reden waarom de oorzaak niet kon worden vastgesteld",
  "delning.slutsats.motivering": "Onderbouwing",
  "delning.slutsats.uteslutet": "Uitgesloten alternatieven",
  "delning.slutsats.atgardsval": "Keuze van de handeling",
  "delning.slutsats.kvarstaende": "Resterende onzekerheid",
  "delning.rubrik.felbeskrivning": "Storingsomschrijving van de klant",
  "delning.rubrik.forslag": "Voorgestelde handeling",
  "delning.forslag.kostnad": "Geschatte kosten: {kostnad}",
  "delning.forslag.beslut": "Uw beslissing: {beslut}",
  "delning.forslag.via": "(vastgelegd via {kanal})",
  "delning.forslag.vantar":
    "In afwachting van uw beslissing — neem contact op met de werkplaats om goed te keuren of af te wijzen.",
  "delning.beslut.rubrik": "Uw beslissing aan de werkplaats",
  "delning.beslut.godkann": "Handeling goedkeuren",
  "delning.beslut.avboj": "Afwijzen",
  "delning.beslut.kommentar": "Opmerking (optioneel)",
  "delning.beslut.motivering": "Korte onderbouwing (optioneel)",
  "delning.beslut.skickar": "Wordt verzonden …",
  "delning.beslut.skicka": "Beslissing verzenden",
  "delning.beslut.info":
    "De beslissing wordt in de zaak vastgelegd en kan hier niet worden gewijzigd — neem contact op met de werkplaats als u zich bedenkt.",
  "delning.beslut.godkant": "Goedgekeurd",
  "delning.beslut.avbojt": "Afgewezen",
  "delning.beslut.delvis": "Gedeeltelijk goedgekeurd",
  "delning.beslut.fel.plattform": "De beslissing kan hier niet worden doorgegeven — neem contact op met de werkplaats.",
  "delning.beslut.fel.registrering": "De beslissing kon niet worden vastgelegd — probeer het opnieuw.",
  "delning.beslut.fel.forbindelse": "De beslissing kon niet worden verzonden — controleer de verbinding.",
  "delning.rubrik.laget": "Huidige stand",
  "delning.rubrik.video": "Video",
  "delning.rubrik.bilder": "Afbeeldingen",
  "delning.rubrik.matningar": "Metingen",
  "delning.rubrik.tidslinje": "Tijdlijn",
  "delning.tidslinje.arbetssprak": "De vermeldingen worden woordelijk weergegeven, in de werktaal van de werkplaats.",
  "delning.rubrik.nasta": "Aanbevolen volgende stap",
  "delning.rubrik.arbetstid": "Arbeidstijd",
  "delning.fot": "Zaak #{nummer} · gestart {datum} · gegenereerd uit het zaaklogboek",
  "delning.notis.kund":
    "Alleen-lezen liveweergave vanuit de werkplaats — de pagina wordt automatisch bijgewerkt zodra nieuwe informatie wordt vastgelegd.",
  "delning.notis.partner":
    "Alleen-lezen liveweergave (partnerniveau) — bevat technische hypothesen, duidelijk gemarkeerd als niet geverifieerd. Wordt automatisch bijgewerkt.",
  "delning.notis.intern":
    "Alleen-lezen liveweergave (intern niveau) — volledig inzicht in de zaak. Wordt automatisch bijgewerkt.",
  "delning.hamtar": "Zaak wordt opgehaald …",
  "delning.saknas": "De zaak is niet beschikbaar. Controleer de link met de werkplaats — de deling kan zijn ingetrokken.",
};
