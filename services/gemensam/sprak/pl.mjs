...
export const PL = {
  ...
  "grind.anmarkning.bevis": "Ustalenia mają dowód wizualny",
  "grind.anmarkning.saknas": "Naprawiona usterka musi być zapisana jako ustalenie",
  "grind.anmarkning.saknas.detalj": "Wykonano naprawę i ustalono przyczynę, ale żadna kontrola nie jest oznaczona jako ustalenie. To, co naprawiono, nie występuje wtedy w dzienniku jako znalezisko.",
