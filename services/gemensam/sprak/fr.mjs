...
export const FR = {
  ...
  "grind.anmarkning.bevis": "Les constats portent une preuve visuelle",
  "grind.anmarkning.saknas": "Un défaut réparé doit être consigné comme un constat",
  "grind.anmarkning.saknas.detalj": "Une intervention a été réalisée et une cause établie, mais aucun contrôle n’est marqué comme constat. Ce qui a été réparé n’apparaît alors nulle part dans le journal comme une découverte.",
