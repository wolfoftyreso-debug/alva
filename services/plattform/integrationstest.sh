...
kontroll "regelpaketet serveras" "$(echo "$REGLER" | falt .version)" "2.1"
kontroll "regelpaketet innehåller garantiregler" "$(echo "$REGLER" | falt '.arendetypRegler.Warranty.length')" "4"
