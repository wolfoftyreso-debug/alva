...
#   terraform output -json for_arbetslast  matas in i infra/terraform
...
output "karta" {
  ...
  value = {
    ...
    kvar_att_gora = compact([
      ...
      "Kör infra/postgres-init.sql mot databasen — schemat med append-only-triggarna.",
...
output "for_arbetslast" {
  description = "Värden som infra/terraform behöver."
